...
test.describe('Customer Care & External Request Portals', () => {
  ...
  test('should submit bill payment successfully', async ({
    authenticatedPage,
    billPayPage,
    testData,
    sessionAccounts,
    ...
    void authenticatedPage;
    const paymentData = { ...testData.billPay, fromAccount: sessionAccounts.primaryAccount };
    await billPayPage.open();
    await billPayPage.submitPayment(paymentData);
  ...
  test('should show loan approval or denial after submitting loan request', async ({
    ...
    void authenticatedPage;
    const loanData = { ...testData.loanRequest, fromAccount: sessionAccounts.primaryAccount };
    await requestLoanPage.visit();
    await requestLoanPage.submitApplication(loanData);
